...
from .backbones import Weights as BackboneWeights, dinov3_vit7b16, dinov3_vitl16plus, dinov3_vitb16, convert_path_or_url_to_url, dinov3_vitl16
...
def _make_dinov3_detector(
    ...
    **kwargs,
    ...
    n_windows_sqrt = dict(dinov3_vit7b16=3, dinov3_vitl16plus=2, dinov3_vitb16=3, dinov3_vitl16=2)[backbone_name]
