...
from otx.algo.detection.dinov3.eval.detection.models.global_ape_decoder import build_global_ape_decoder
from otx.algo.detection.dinov3.eval.detection.models.global_rpe_decomp_decoder import build_global_rpe_decomp_decoder
from otx.algo.detection.dinov3.eval.detection.models.transformer_encoder import TransformerEncoder, TransformerEncoderLayer
...
class Transformer(nn.Module):
    ...
    def forward(self, srcs, masks, pos_embeds, query_embed=None, self_attn_mask=None):
        ...
        valid_ratios = torch.stack([self.get_valid_ratio(m) for m in masks], 1).to(src_flatten.dtype)
...
def build_dinov3_transformer(
    ...
    norm_type,
    decoder_type,
    proposal_feature_levels,
    proposal_in_stride,
    proposal_tgt_strides,
    proposal_min_size,
    ...
    return Transformer(
        ...
        proposal_feature_levels=proposal_feature_levels,
        proposal_in_stride=proposal_in_stride,
        proposal_tgt_strides=proposal_tgt_strides,
        proposal_min_size=proposal_min_size,
        add_transformer_encoder=add_transformer_encoder,
