...
from otx.algo.detection.dinov3.eval.detection.util.misc import NestedTensor
from otx.algo.detection.dinov3.eval.detection.models.position_encoding import build_position_encoding
from otx.algo.detection.dinov3.eval.detection.models.utils import LayerNorm2D
from otx.algo.detection.dinov3.eval.detection.models.windows import WindowsWrapper
...
def build_dinov3_detection_backbone(
    backbone_model,
    position_embedding = PositionEncoding.SINE,
    hidden_dim = 768, 
    num_feature_levels = 1,
    blocks_to_train = None,
    layers_to_use: list[int] = [9, 19, 29, 39],
    ...
    backbone = DINOBackbone(
        ...
        blocks_to_train, 
        layers_to_use, 
        backbone_use_layernorm,
    )
    
    backbone = WindowsWrapper(
        backbone,
        n_windows_w=n_windows_sqrt, 
        n_windows_h=n_windows_sqrt, 
